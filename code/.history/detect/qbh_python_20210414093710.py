...
class Qbh_Gui():
    ...
    def root_window(self):
        ...
        self.pauseBtn = tk.Button(self.root,music_iat image=self.pauseimg,command=self.pause)
        ...
        self.context_sub = tk.Text(self.subject_frame,width=50,height=10,
             yscrollcommand=self.scroll_barmusic_iatfe371ccdf"

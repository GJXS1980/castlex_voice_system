...
class Chatbot:
    ...
    @logger(is_timed=False)
    def __get_cached_access_token(self, email):
    ...
    @logger(is_timed=False)
    def __cache_access_token(self, email, access_token):
...
def configure():
    ...
    windows_home = getenv("HOMEPATH")
    if windows_home != None:

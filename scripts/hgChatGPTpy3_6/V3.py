...
class Chatbot:
    ...
    def __init__(
        ...
        self.truncate_limit = truncate_limit or (
    ...
    def __truncate_conversation(self, convo_id = "default") -> None:
        """
    ...
    def get_max_tokens(self, convo_id):
        """
        Get max tokens
        """
    ...
    async def ask_async(
        ...
        **kwargs,
        ...
        full_response = "".join([r async for r in response])
    ...
    def rollback(self, n = 1, convo_id = "default") -> None:
        """
    ...
    def reset(self, convo_id = "default", system_prompt = None) -> None:
        """
...
class ChatbotCLI(Chatbot):
    ...
    def print_config(self, convo_id = "default"):
        """
...
Examples:
  ...
  """,
    ...
    def handle_commands(self, prompt, convo_id = "default"):
        """
